...
def migrate_locations_to_services(apps, schema_editor):
    ...
    RestaurantDeliveryLocation = apps.get_model(
        "delivery_locations", "RestaurantDeliveryLocation"
    )
    ...
    for location in DeliveryLocation.objects.order_by("created_at", "id"):
        ...
        if canonical is None:
            ...
            Cart.objects.filter(delivery_location_id=location.id).update(
                delivery_location_id=canonical.id
            )
            Order.objects.filter(delivery_location_id=location.id).update(
                delivery_location_id=canonical.id
            )
...
def reverse_locations_to_restaurant_owned(apps, schema_editor):
    ...
    for service in RestaurantDeliveryLocation.objects.select_related(
        "delivery_location"
    ):
        ...
        if location.restaurant_id is None:
            ...
            location.save(
                update_fields=["restaurant", "capacity_per_slot", "updated_at"]
            )
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="restaurant_services",
                        to="delivery_locations.deliverylocation",
                    ),
                ),
                (
                    "restaurant",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="delivery_locations.locationrequest",
                    ),
                ),
                (
                    "requester",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="reviewed_location_requests",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("restaurant", "delivery_location"),
                name="unique_restaurant_delivery_location",
            ),
        ),
        migrations.RunPython(
            migrate_locations_to_services, reverse_locations_to_restaurant_owned
        ),
        ...
        migrations.AddConstraint(
            model_name="deliverylocation",
            constraint=models.UniqueConstraint(
                fields=("name", "address"), name="unique_delivery_location_name_address"
            ),
        ),
    ]
